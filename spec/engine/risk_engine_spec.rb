...
RSpec.describe FCS::Engine::RiskEngine do
  ...
  it 'passes interpolation options to I18n' do
    engine = described_class.new(account_collateral: {}, risk_config: {})

    expect(::I18n).to receive(:t)
      .with('fcs.engine.risk.invalid_decimal18', value: 'x')
      .and_return('ok')

    expect(engine.send(:t, 'fcs.engine.risk.invalid_decimal18', value: 'x')).to eq('ok')
  end
end
