...
ActiveRecord::Schema[8.1].define(version: 20_260_402_120_000) do
  ...
  create_table 'fx_daily_rates', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[operational_date base_currency quote_currency], name: 'idx_fx_daily_rates_unique', unique: true
  ...
  create_table 'fx_rate_gaps', force: :cascade do |t|
    ...
    t.string 'status', null: false
    t.datetime 'updated_at', null: false
    t.index %w[operational_date base_currency quote_currency], name: 'idx_fx_rate_gaps_open', unique: true,
  ...
  create_table 'run_daily_events', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[run_snapshot_id event_seq], name: 'index_run_daily_events_on_run_snapshot_id_and_event_seq',
                                           unique: true
  end
  ...
  create_table 'run_snapshots', force: :cascade do |t|
    ...
    t.bigint 'run_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[run_id operational_date reporting_currency], name: 'idx_run_snapshots_unique', unique: true
  end
